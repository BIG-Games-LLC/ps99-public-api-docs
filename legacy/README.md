> **These are the original `/api/*` endpoints.** They are fully supported and not deprecated. For new integrations involving player accounts or public profiles, see [v1/](../v1/) instead.
>
> Looking for the docs landing page? See [the repo root README](../README.md).
